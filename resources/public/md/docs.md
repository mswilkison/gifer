<div class="bs-callout bs-callout-danger">
 ...
 <ol>
   ...
   <li> Update the connection parameters for the database in the <code>gifer.models.schema</code> namespace of your application.
...
Two middleware functions by default which are are located in the `gifer.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `gifer.handler` namespace to manage the enabled middleware.
